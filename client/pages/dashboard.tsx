  ...
  return (
    ...
    >
      <div className="flex items-center justify-between">
        ...
        <div className={`flex h-12 w-12 flex-none items-center justify-center rounded-xl ${stat.color} text-white shadow-lg transition-transform duration-200`}>
...
const ErrorFallback = ({ error, resetError }: { error: Error, resetError: () => void }) => (
  <div className="card bg-red-50 border-red-200">
    <div className="text-center">
        <Suspense fallback={<div className="h-12 w-12 bg-gray-200 rounded mx-auto mb-4"></div>}>
...
export default function Dashboard() {
  ...
  // Fetch customers (latest) for list
  useEffect(() => {
    const load = async () => {
      try {
            ...
            <div className="space-y-6">
              <div className="flex items-center justify-between">
                <h2 className="text-2xl font-bold text-gray-900 flex items-center">
                  <Suspense fallback={<div className="h-6 w-6 mr-3 bg-gray-200 rounded "></div>}>
                ...
                <div className="flex items-center justify-between">
                  <div>
                    <h3 className="text-xl font-bold bg-gradient-to-r from-blue-600 to-indigo-600 bg-clip-text text-transparent flex items-center">
                      <Suspense fallback={<div className="h-5 w-5 mr-2 bg-gray-200 rounded"></div>}>
